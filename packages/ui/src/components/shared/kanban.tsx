...
function KanbanColumn<T extends KanbanItemBase>({
  ...
  return (
    <div
      ...
      className={cn("flex w-64 shrink-0 flex-col gap-y-2 sm:w-72", isDragging && "z-50 opacity-50")}
    >
      <div
  ...
  return (
    ...
    >
      <div data-slot="kanban" className={cn("w-full overflow-hidden", className)}>
        <div className="flex w-auto snap-x snap-mandatory items-start gap-x-2 overflow-x-auto p-1">
