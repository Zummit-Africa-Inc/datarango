  ...
  return (
    <ChartContext.Provider value={{ config }}>
      <div
        data-slot="chart"
        data-chart={chartId}
        // Caller styles merge over the series variables; they must not replace them.
...
function ChartTooltipContent({
  ...
  return (
    <div
      className={cn(
        "border-border/50 bg-background grid min-w-32 items-start gap-1.5 rounded-xs border px-2.5 py-1.5 text-xs shadow-xl",
        className,
      )}
    >
